...
public class RegisteredInstructorController {
	...
	public ResponseEntity<?> registerInstructor(@Valid @RequestBody RegisteredInstructorsEntity instructor){
		
		 System.out.println("Received instructor data: " + instructor);
